...
public class FavoritesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void init() {
        ...
        mFavoritesAPI = new FavoritesAPI(getApplicationContext(), Constants.APP_KEY, mAccessToken);
        ...
        tv_title = (TextView) findViewById(R.id.tv_title_activity_my_status);
        tv_title.setText("我的收藏");
        lv_status = (ListView) findViewById(R.id.lv_status_activity_my_status);
        adapter = new MyListAdapter();
        lv_status.setAdapter(adapter);
        mFavoritesAPI.favorites(200,1,new MyRequestListener());
    }
    ...
    class MyRequestListener implements RequestListener {
        ...
        public void onComplete(String s) {
            FavoriteList favoriteList = FavoriteList.parse(s);
            if (favoriteList != null && favoriteList.favoriteList != null) {
                for (Favorite favorite : favoriteList.favoriteList) {
                    list.add(favorite.status);
                }
        ...
        public void onWeiboException(WeiboException e) {
            ...
            Toast.makeText(FavoritesActivity.this, "更新失败，请检查网络是否正常...", Toast.LENGTH_SHORT).show();
        }
    }
