...
public class FollowerActivity extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemClickListener {
    private ImageButton ibtn_refresh,ibtn_return;
    private ListView lv_followers;
    ...
    private void init() {
        ...
        mFriendshipsAPI.followers(Long.parseLong(mAccessToken.getUid()),200,0,false,new MyRequestListener());
    }
